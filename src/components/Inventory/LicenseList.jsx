...
import { Edit, Trash2, Plus, Search, Filter, Upload, Loader2 } from 'lucide-react';
...
const LicenseList = () => {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      await loadLicenses(); // Refresh the list
    } catch (err) {
      console.error(err);
      alert("Failed to import CSV. Ensure columns match: ProductName,Vendor,LicenseType,TotalEntitlements,Cost,PurchaseDate,ExpiryDate");
    } finally {
      setUploading(false);
    }
  };
